...
const HeroSection = () => {
  return (
    <div className="relative h-[80vh] flex items-center bg-gradient-to-r from-gray-900 to-gray-800 text-white">
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
            Transforming Organizations Through Cultural Wisdom
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
            Expert policy advice, strategic guidance, and cultural competency training to empower businesses, government agencies, and Aboriginal organizations.
          </p>
