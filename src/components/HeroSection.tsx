...
const HeroSection = () => {
  return <div className="relative h-[80vh] flex items-center bg-gradient-to-r from-grey-900 to-grey-800 text-white">
      {/* Background image overlay - replace the URL with your actual image */}
      <div className="absolute inset-0 bg-black/50 z-0">
        <div className="absolute inset-0 bg-cover bg-centre" style={{
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl mb-8 text-grey-200">Expert policy advice, strategic guidance, and cultural competency training to empower businesses, government agencies, and Aboriginal organisations.</p>
